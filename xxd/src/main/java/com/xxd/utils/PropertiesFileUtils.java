...
public class PropertiesFileUtils {
    ...
    static {
        try {
            ...
            InputStream configInputStream = PropertiesFileUtils.class.getClassLoader().getResourceAsStream(Constans.SYSTEM_PROPERTIES);
    ...
    private static String getPropertiesPath() {
        ...
        return path + Constans.SYSTEM_PROPERTIES;
    }
