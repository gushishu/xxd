...
import com.xxd.services.impls.XxdUserAddrSI;
import com.xxd.utils.Constans;

@Controller
@RequestMapping(value = "/XxdUserAddr")
public class XxdUserAddrC {

	@Autowired
	private XxdUserAddrSI serviceImpl;

	@RequestMapping(value = "/insert")
	@ResponseBody
	public HashMap<String, Object> insert(XxdUserAddr model){
	...
	@ResponseBody
	public HashMap<String, Object> updateByPrimaryKeySelective(XxdUserAddr model){
	...
	public HashMap<String, Object> selectByPrimaryKey(Integer primaryKey){
		XxdUserAddr con = serviceImpl.selectByPrimaryKey(primaryKey);
	...
	public HashMap<String, Object> selectAll(){
		ArrayList<XxdUserAddr> con = serviceImpl.selectAll();
		return Constans.returnCon(null == con ? 1 : -1, con);
	}
